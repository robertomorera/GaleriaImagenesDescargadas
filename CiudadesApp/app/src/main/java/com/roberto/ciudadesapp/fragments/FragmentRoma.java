...
public class FragmentRoma extends Fragment {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_roma,container,false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Button boton_roma=(Button) getView().findViewById(R.id.boton_roma);
        //Asignamos el listener al botón.
        ListenerButtons listenerButtons=new ListenerButtons(getView().getContext());
        boton_roma.setOnClickListener(listenerButtons);
    }
}
